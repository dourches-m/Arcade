//
// OpenEvent.cpp for Open in /home/dourches/Epitech/Seconde/CPP/cpp_arcade/lib/sfml
// 
// Made by dourches
// Login   <martin.dourches@epitech.eu>
// 
// Started on  Wed Apr  5 10:53:29 2017 dourches
// Last update Sun Apr  9 05:53:22 2017 dourches
//

#include	"OpenContext.hpp"
#include	"OpenEvent.hpp"

OpenEvent::OpenEvent(OpenContext &context) : _context(context)
{
}
...
bool OpenEvent::keyPressed(IEvents::Key id) const
{
  for (auto it : _key)
    if (it == id)
      return (true);
...
std::vector<arcade::api::IEvents::Key> const &OpenEvent::getKey() const
{
  return (_key);
}

bool OpenEvent::mouseButtonPressed(arcade::api::IEvents::MouseKey id) const
{
...
arcade::utl::Position OpenEvent::getMousePos() const
{
